export default {
  ...
  'protocol-unregister-manual-required': 'Limitato dal sistema, modificalo manualmente.',
  ...
  'async-dns-hint': 'Migliora le prestazioni DNS, ma può non funzionare in alcuni ambienti di rete.',
