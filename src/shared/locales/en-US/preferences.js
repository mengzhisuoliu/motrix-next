export default {
  ...
  'protocol-unregister-manual-required': 'Restricted by the system, please change it manually.',
  ...
  'async-dns': 'Asynchronous DNS',
  'async-dns-hint': 'Improves DNS performance, but may fail in some network environments.',
